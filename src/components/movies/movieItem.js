...
import { HashLink as Link } from 'react-router-hash-link';
 const MovieItem = ({movie:{id,title,poster,genres}}) => {
    ...
    return (
            <div className="card " style={{ border:"0px",borderRadius:"5px",backgroundImage: "linear-gradient(to bottom right,rgb( 33,37,41),#dc3545)", opacity:"0.95",width: "18rem",margin:"1.5% 0 1.5% 2.5%"}}>
